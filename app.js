...
const FOODS = [
  ...
  // more parathas (veg)
  { n: "Paneer paratha", unit: "paratha", base: 1, cal: 290, p: 12, c: 32, f: 13 },
  { n: "Methi paratha", unit: "paratha", base: 1, cal: 200, p: 5, c: 28, f: 8 },
  { n: "Mooli paratha", unit: "paratha", base: 1, cal: 210, p: 5, c: 30, f: 8 },
  { n: "Onion paratha", unit: "paratha", base: 1, cal: 220, p: 5, c: 31, f: 9 },
  { n: "Mix veg paratha", unit: "paratha", base: 1, cal: 240, p: 6, c: 33, f: 9 },
  { n: "Lachha paratha", unit: "paratha", base: 1, cal: 280, p: 6, c: 36, f: 13 },
  { n: "Sattu paratha", unit: "paratha", base: 1, cal: 260, p: 10, c: 34, f: 9 },
  { n: "Paneer cheese paratha", unit: "paratha", base: 1, cal: 360, p: 15, c: 34, f: 18 },
  // Sindhi / Punjabi street
  { n: "Dal pakwan", unit: "plate", base: 1, cal: 480, p: 13, c: 56, f: 22 },
  { n: "Chole kulche", unit: "plate", base: 1, cal: 450, p: 13, c: 62, f: 16 },
  { n: "Amritsari kulcha", unit: "kulcha", base: 1, cal: 330, p: 8, c: 44, f: 14 },
  { n: "Aloo kulcha", unit: "kulcha", base: 1, cal: 300, p: 7, c: 44, f: 11 },
  { n: "Paneer kulcha", unit: "kulcha", base: 1, cal: 340, p: 12, c: 42, f: 14 },
  { n: "Onion kulcha", unit: "kulcha", base: 1, cal: 290, p: 7, c: 43, f: 10 },
  { n: "Plain kulcha", unit: "kulcha", base: 1, cal: 230, p: 6, c: 40, f: 5 },
  ...
  // packaged snacks / chips (veg)
  { n: "Lays Classic Salted (small, 28g)", unit: "pack", base: 1, cal: 156, p: 2, c: 16, f: 10 },
  { n: "Lays Magic Masala (small, 28g)", unit: "pack", base: 1, cal: 155, p: 2, c: 16, f: 10 },
  { n: "Lays Cream & Onion (small, 28g)", unit: "pack", base: 1, cal: 158, p: 2, c: 16, f: 10 },
  { n: "Lays Tomato Tango (small, 28g)", unit: "pack", base: 1, cal: 155, p: 2, c: 16, f: 10 },
  { n: "Lays (medium pack, 52g)", unit: "pack", base: 1, cal: 290, p: 3.5, c: 30, f: 18 },
  { n: "Lays (large pack, 90g)", unit: "pack", base: 1, cal: 500, p: 6, c: 52, f: 31 },
  { n: "Lays", unit: "g", base: 100, cal: 556, p: 6.6, c: 56, f: 35 },
  { n: "Kurkure (small, 30g)", unit: "pack", base: 1, cal: 165, p: 2, c: 18, f: 9 },
  { n: "Bingo / nachos (small)", unit: "pack", base: 1, cal: 150, p: 2, c: 17, f: 8 },
  { n: "Potato wafers", unit: "g", base: 100, cal: 540, p: 6, c: 53, f: 34 },
  { n: "Aloo bhujia / namkeen", unit: "g", base: 100, cal: 540, p: 12, c: 45, f: 35 },
  ...
  { n: "McDonald's fries (large)", unit: "serving", base: 1, cal: 440, p: 5, c: 57, f: 21 },
  { n: "McDonald's Veg McMuffin", unit: "piece", base: 1, cal: 290, p: 8, c: 38, f: 12 },
  { n: "McDonald's Hash Brown", unit: "piece", base: 1, cal: 140, p: 1.5, c: 15, f: 8 },
  { n: "McDonald's Masala Wedges", unit: "serving", base: 1, cal: 290, p: 4, c: 36, f: 14 },
  { n: "McDonald's Veg Pizza McPuff", unit: "piece", base: 1, cal: 230, p: 5, c: 27, f: 11 },
  { n: "McDonald's McFlurry (Oreo)", unit: "cup", base: 1, cal: 280, p: 6, c: 42, f: 9 },
  { n: "McDonald's Soft Serve Cone", unit: "cone", base: 1, cal: 150, p: 4, c: 24, f: 4 },
  { n: "McDonald's Hot Fudge Sundae", unit: "cup", base: 1, cal: 240, p: 5, c: 40, f: 7 },
  { n: "McDonald's Chocolate Shake", unit: "glass", base: 1, cal: 380, p: 9, c: 60, f: 11 },
  // Domino's (veg) — Indian sizes: regular = 4 slices (~7\"), medium = 6 slices (~11\")
  { n: "Domino's Margherita (slice, regular)", unit: "slice", base: 1, cal: 100, p: 4, c: 14, f: 3 },
  { n: "Domino's Cheese & Corn (slice, regular)", unit: "slice", base: 1, cal: 120, p: 5, c: 15, f: 5 },
  { n: "Domino's Farmhouse (slice, regular)", unit: "slice", base: 1, cal: 115, p: 5, c: 15, f: 4 },
  { n: "Domino's Peppy Paneer (slice, regular)", unit: "slice", base: 1, cal: 125, p: 5, c: 15, f: 5 },
  { n: "Domino's Veg Extravaganza (slice, regular)", unit: "slice", base: 1, cal: 130, p: 5, c: 15, f: 5 },
  { n: "Domino's Mexican Green Wave (slice, regular)", unit: "slice", base: 1, cal: 120, p: 5, c: 15, f: 5 },
  { n: "Domino's Margherita (regular, whole)", unit: "pizza", base: 1, cal: 400, p: 16, c: 56, f: 12 },
  { n: "Domino's Peppy Paneer (regular, whole)", unit: "pizza", base: 1, cal: 500, p: 20, c: 60, f: 20 },
  { n: "Domino's Farmhouse (regular, whole)", unit: "pizza", base: 1, cal: 460, p: 20, c: 60, f: 16 },
  ...
  { n: "Domino's Margherita (medium, whole)", unit: "pizza", base: 1, cal: 1020, p: 42, c: 132, f: 36 },
  { n: "Domino's Peppy Paneer (medium, whole)", unit: "pizza", base: 1, cal: 1260, p: 54, c: 144, f: 54 },
  { n: "Domino's Farmhouse (medium, whole)", unit: "pizza", base: 1, cal: 1140, p: 48, c: 144, f: 42 },
